                    ...
                    <div class="flex flex-wrap -m-2">
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.name" :message="errors.name"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.memo" :message="errors.memo"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.price" :message="errors.price"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="radio" id="is_selling" name="pris_sellingice" v-model="form.is_selling" value="1">
                          <label class="ml-2">販売中</label>
                          <input type="radio" id="is_selling" name="pris_sellingice" v-model="form.is_selling" value="0">
                          <label class="ml-2">停止中</label>
                        </div>
                      </div>

                      <div class="p-2 w-full">
                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">変更</button>
                      </div>
                    </div>
                  </div>
                </div>
