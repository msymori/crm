                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.kana" :message="errors.kana"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.tel" :message="errors.tel"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.postcode" :message="errors.postcode"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.address" :message="errors.address"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <Error v-if="errors.birthday" :message="errors.birthday"></Error>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <label for="gende2" class="ml-2">その他</label>
                        </div>
                      </div>
